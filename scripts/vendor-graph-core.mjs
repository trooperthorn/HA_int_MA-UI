/**
 * Refresh src/vendor/graph-core/ from a local clone of trooperthorn/relationship-maps.
 *
...
const DEST = resolve(HERE, "..", "src", "vendor", "graph-core");
...
for (const [name, path] of Object.entries(FILES)) {
  ...
  const header =
    ...
    "// Framework-neutral engine only: no React. Refresh with src/vendor/graph-core/VENDOR.md.\n";
